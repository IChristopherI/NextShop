...
const LoginForm: React.FC<Props> = ({ className, onClose }) => {
  ...
  return (
    <FormProvider {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className='flex flex-col gap-4 p-2 bg-white shadow-lg rounded-xl  '>
        <div className="text-center">
          <h1 className="text-2xl font-semibold">Вход</h1>
          <p className="text-gray-500 text-sm mt-1">Введите данные для входа</p>
        </div>
